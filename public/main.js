...
var _user$project$GraphQL$apply = F2(
	function (func, value) {
		return A3(
			_elm_lang$core$Json_Decode$map2,
			F2(
...
var _user$project$GraphQL$queryResult = function (decoder) {
	return _elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
			_0: A2(
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Json_Decode$fail('Expected \'data\' field'),
				_1: {ctor: '[]'}
			}
		});
};
		...
		var params = _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'operationName',
						_1: _elm_lang$core$Json_Encode$string(operation)
					},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'variables', _1: variables},
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Attendance_Decoders$attendanceDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
	...
	A2(_elm_lang$core$Json_Decode$field, 'member', _elm_lang$core$Json_Decode$string));
var _user$project$Attendance_Decoders$attendancesDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$list(_user$project$Attendance_Decoders$attendanceDecoder));

var _user$project$Attendance$attendance = function (token) {
	var graphQLQuery = 'query attendance { attendance { event member } }';
	var graphQLParams = _elm_lang$core$Json_Encode$object(
		{ctor: '[]'});
	return A6(_user$project$GraphQL$query, 'GET', token, graphQLQuery, 'attendance', graphQLParams, _user$project$Attendance_Decoders$attendancesDecoder);
};
...
var _user$project$Attendance_Actions$OnAttend = F2(
	function (a, b) {
...
var _user$project$Attendance_Submit$submitAttendanceDecoder = function (key) {
	return A2(
		_elm_lang$core$Json_Decode$map,
		...
		A2(
			...
			_user$project$Attendance_Decoders$attendanceDecoder));
};
var _user$project$Attendance_Submit$submit = F3(
	function (token, event, member) {
		var _p0 = {
			ctor: '_Tuple3',
			_0: 'CreateAttendance',
			_1: 'mutation CreateAttendance($input: CreateAttendanceInput!) { createAttendance(input: $input) { attendance { event member } } }',
			_2: _user$project$Attendance_Submit$submitAttendanceDecoder('createAttendance')
		};
...
var _user$project$Attendance_Commands$submit = F3(
	function (token, event, member) {
		var httpTask = _elm_lang$http$Http$toTask(
			A3(_user$project$Attendance_Submit$submit, token, event, member));
		return A2(_elm_lang$core$Task$attempt, _user$project$Attendance_Actions$ReceiveAttendance, httpTask);
	});
var _user$project$Attendance_Commands$fetch = function (token) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Attendance_Actions$ReceiveAttendance,
...
var _user$project$Attendance_Update$receiveAttendance = F2(
	function (response, model) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			A2(_user$project$Attendance_Update$updateAttendance, model, response),
			{ctor: '[]'});
	});
...
var _user$project$Events_Actions$OnSelectEvent = function (a) {
	return {ctor: 'OnSelectEvent', _0: a};
};
...
var _user$project$MDC$formFields = function (children) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdc-form-field'),
			_1: {ctor: '[]'}
		},
		children);
};
var _user$project$MDC$formField = function (child) {
	return _user$project$MDC$formFields(
		_elm_lang$core$List$singleton(child));
};
var _user$project$MDC$checkbox = F3(
	function (label, checked, onToggle) {
		return _user$project$MDC$formFields(
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('mdc-checkbox'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(onToggle),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('mdc-checkbox__native-control'),
										_1: {
											ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('mdc-checkbox__background'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('mdc-checkbox__mixedmark'),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {ctor: '[]'}
...
var _user$project$MDC$persistentDrawer = F2(
	function (toggled, items) {
		var classes = toggled ? _elm_lang$html$Html_Attributes$class('mdc-persistent-drawer mdc-typography mdc-persistent-drawer--open') : _elm_lang$html$Html_Attributes$class('mdc-persistent-drawer mdc-typography');
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('mdc-persistent-drawer__drawer'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('mdc-permanent-drawer__toolbar-spacer'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('icon-with-text-demo'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('mdc-persistent-drawer__content mdc-list'),
										_1: {ctor: '[]'}
									}
								},
								items),
...
var _user$project$MDC$toolbar = F2(
	function (title, onToggle) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('mdc-toolbar mdc-toolbar---theme-dark mdc-elevation--z1'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('mdc-toolbar__row'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('mdc-toolbar__section mdc-toolbar__section--align-start'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('material-icons mdc-toolbar__icon--menu'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(onToggle),
												_1: {ctor: '[]'}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('mdc-toolbar__title'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _user$project$MDC$datepicker = F3(
	function (value, label, onChange) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('mdc-textfield mdc-textfield--box'),
				_1: {
					ctor: '::',
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('date-input'),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('mdc-textfield__input'),
										_1: {
											ctor: '::',
											_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-language', 'en'),
											_1: {
												ctor: '::',
...
var _user$project$MDC$input = F4(
	function (type_, value, label, onChange) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('mdc-textfield mdc-textfield--fullwidth mdc-textfield--box'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
...
var _user$project$MDC$drawerItem = F3(
	function (msg, icon, child) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('mdc-list-item mdc-persistent-drawer--selected'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href('#'),
					_1: {
...
var _user$project$MDC$menu = F2(
	function (toggled, items) {
		var classes = _elm_lang$html$Html_Attributes$class(
			toggled ? 'mdc-simple-menu mdc-simple-menu--open' : 'mdc-simple-menu');
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('mdc-simple-menu__items mdc-list'),
						_1: {
							ctor: '::',
						...
						function (node) {
							return A2(
								_elm_lang$html$Html$li,
								{
									...
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'role', 'menuitem'),
										_1: {
											ctor: '::',
...
var _user$project$Events_List$eventRow = F2(
	function (selectedEvent, event) {
		var isSelected = function () {
			var _p2 = selectedEvent;
			if (_p2.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p2._0, event);
			} else {
				return false;
			}
		}();
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Events_Actions$OnSelectEvent(event)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _user$project$MDC$icon('event available'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
...
var _user$project$Events_List$render = F2(
	function (selectedEvent, _p3) {
		var _p4 = _p3;
		return function (rows) {
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Events_List$eventRow(selectedEvent),
				_p4.events));
	});
...
var _user$project$Members_Actions$OnAttend = function (a) {
	return {ctor: 'OnAttend', _0: a};
};
...
var _user$project$Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {members: a, events: b, attendance: c, flags: d, route: e, user: f, event: g};
	});
var _user$project$Model$Menu = {ctor: 'Menu'};
var _user$project$Model$OnSelectEvent = function (a) {
	return {ctor: 'OnSelectEvent', _0: a};
};
...
var _user$project$Model$AttendanceApp = function (a) {
	return {ctor: 'AttendanceApp', _0: a};
};
...
var _user$project$Events_View$render = F2(
	function (event, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				return A2(_user$project$Events_List$render, event, model);
		}
	});
...
var _user$project$Utils$dateStringToString = function (date) {
	var _p1 = _elm_lang$core$Date$fromString(date);
	if (_p1.ctor === 'Ok') {
		return _user$project$Utils$dateToString(_p1._0);
	} else {
		return '';
	}
};
...
var _user$project$Members_List$filterRow = function (filters) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdc-theme--secondary-bg'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Members_List$memberRow = F2(
	function (attendees, member) {
		var attending = A2(_elm_lang$core$List$member, member.id, attendees);
		return A2(
			_elm_lang$html$Html$tr,
			{
				ctor: '::',
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Members_Actions$OnAttend(member)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _user$project$MDC$icon('face'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Members_List$render = F2(
	function (_p2, attendees) {
		var _p3 = _p2;
		var _p4 = _p3.filters;
		return function (rows) {
			return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Members_List$memberRow(attendees),
...
var _user$project$Members_View$render = F2(
	function (model, attendees) {
		var _p0 = model.route;
		switch (_p0.ctor) {
			case 'Add':
			...
			case 'Delete':
				return _elm_lang$html$Html$text('WIP');
			default:
				return A2(_user$project$Members_List$render, model, attendees);
		}
	});
...
var _user$project$Update$updateAttendance = F2(
	function (action, model) {
		var next = A2(
			_user$project$Update$authenticatedUpdate,
			model,
			A2(_user$project$Attendance_Update$update, action, model.attendance));
		var _p3 = next;
		if (_p3.ctor === 'Just') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
					{attendance: _p3._0._0}),
				{
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Model$AttendanceApp, _p3._0._1),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
				...
				default:
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								event: _elm_lang$core$Maybe$Just(_p5._0)
							}),
						{ctor: '[]'});
			}
		}
...
var _user$project$Main$attendees = function (model) {
	var _p0 = model.event;
	if (_p0.ctor === 'Just') {
		return A2(
			_elm_lang$core$List$map,
			...
			A2(
				...
				function (_p3) {
					var _p4 = _p3;
					return _elm_lang$core$Native_Utils.eq(_p4._0, _p0._0.id);
				},
				model.attendance));
	} else {
		return {ctor: '[]'};
...
var _user$project$Main$routedView = function (model) {
	...
	if (_p5.ctor === 'MembersRoute') {
		return A2(
			...
			A2(
				_user$project$Members_View$render,
				model.members,
				_user$project$Main$attendees(model)));
	} else {
		return A2(
			_elm_lang$html$Html$map,
			_user$project$Model$EventsApp,
			A2(_user$project$Events_View$render, model.event, model.events));
	}
};
...
var _user$project$Main$toolbar = function (model) {
	var event = function () {
		var _p6 = model.event;
		if (_p6.ctor === 'Just') {
			var _p7 = _p6._0;
...
var _user$project$Main$authenticatedView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mdc-theme--background mdc-typography mdc-typography--body1'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					{
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$toolbar(model),
						_1: {
							ctor: '::',
							_0: _user$project$Main$routedView(model),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Main$view = function (model) {
	var _p8 = _user$project$Login$isAuthenticated(model.user);
	if (_p8 === true) {
...
var _user$project$Main$init = function (_p9) {
	...
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_user$project$Main$initialModel(_p12),
		function () {
			var _p11 = _elm_lang$core$String$isEmpty(_p12);
			if (_p11 === true) {
				return {ctor: '[]'};
			} else {
				return {
					...
					_0: A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$Model$MembersApp,
						_user$project$Members_Commands$fetch(_p12)),
					_1: {ctor: '[]'}
				};
			}
		}());
