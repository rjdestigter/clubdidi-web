...
var _user$project$MembersData$uniqueList = function (list) {
	return _elm_lang$core$Set$toList(
		_elm_lang$core$Set$fromList(list));
};
var _user$project$MembersData$endpointUrl = 'http://138.197.161.149:8080/graphql/';
var _user$project$MembersData$Member = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, firstName: b, lastName: c, email: d, dateOfBirth: e, payed: f, volunteer: g, roles: h};
	});
var _user$project$MembersData$Other = function (a) {
	return {ctor: 'Other', _0: a};
};
var _user$project$MembersData$WhateverMamaNeeds = {ctor: 'WhateverMamaNeeds'};
var _user$project$MembersData$Cleaning = {ctor: 'Cleaning'};
var _user$project$MembersData$Maintenance = {ctor: 'Maintenance'};
var _user$project$MembersData$Tech = {ctor: 'Tech'};
var _user$project$MembersData$SetUp = {ctor: 'SetUp'};
var _user$project$MembersData$Floating = {ctor: 'Floating'};
var _user$project$MembersData$Security = {ctor: 'Security'};
var _user$project$MembersData$BarTending = {ctor: 'BarTending'};
var _user$project$MembersData$FrontOfHouse = {ctor: 'FrontOfHouse'};
var _user$project$MembersData$stringToRole = function (role) {
	var _p0 = _elm_lang$core$String$toUpper(
		A2(
			_elm_lang$core$String$join,
			'',
			A2(_elm_lang$core$String$split, ' ', role)));
	switch (_p0) {
		case 'FRONTOFHOUSE':
			return _user$project$MembersData$FrontOfHouse;
		case 'BARTENDING':
			return _user$project$MembersData$BarTending;
		case 'SECURITY':
			return _user$project$MembersData$Security;
		case 'FLOATING':
			return _user$project$MembersData$Floating;
		case 'SET-UP':
			return _user$project$MembersData$SetUp;
		case 'TECH':
			return _user$project$MembersData$Tech;
		case 'MAINTENANCE':
			return _user$project$MembersData$Maintenance;
		case 'CLEANING':
			return _user$project$MembersData$Cleaning;
		case 'WHATEVERMAMANEEDS':
			return _user$project$MembersData$WhateverMamaNeeds;
		default:
			return _user$project$MembersData$Other(role);
	}
};
var _user$project$MembersData$rolesDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_elm_lang$core$List$map(_user$project$MembersData$stringToRole),
	A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$MembersData$uniqueList,
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$MembersData$memberDecoder = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$MembersData$Member,
	...
	A2(_elm_lang$core$Json_Decode$field, 'roles', _user$project$MembersData$rolesDecoder));
var _user$project$MembersData$membersDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$list(_user$project$MembersData$memberDecoder));
var _user$project$MembersData$members = function () {
	var graphQLQuery = 'query members { members { id firstName lastName email volunteer payed roles dateOfBirth } }';
	var graphQLParams = _elm_lang$core$Json_Encode$object(
		{ctor: '[]'});
	return A6(_user$project$GraphQL$query, 'GET', _user$project$MembersData$endpointUrl, graphQLQuery, 'members', graphQLParams, _user$project$MembersData$membersDecoder);
}();
...
var _user$project$Main$init = function () {
	var commands = A2(_elm_lang$http$Http$send, _user$project$Model$ReceiveMembers, _user$project$MembersData$members);
				...
				switch (_p8.ctor) {
					case 'AddMember':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{route: _p10, mutate: _user$project$Main$blankMember}),
							{ctor: '[]'});
					case 'EditMember':
						var _p9 = _p8._0;
						if (_p9.ctor === 'Just') {
